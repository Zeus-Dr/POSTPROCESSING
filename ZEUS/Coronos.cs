...
namespace ZEUS
{
    public class Coronos
    {
        ...
        public void ResizeFrame(string imagePath,string outputPath) {
            try {
                // Load the image
                ...
                int outputWidth = 720; // Desired output frame width
                int outputHeight = 720; // Desired output frame height
